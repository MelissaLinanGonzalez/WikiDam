...
import { FileText, Video, Image, LinkIcon, Youtube, Plus, Filter, Tag } from 'lucide-react';
...
async function getResources() {
    const resources = await prisma.resource.findMany({
        include: {
            subject: true,
            youtuber: true,
            categories: true, // Importante: traer las categorías
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {resources.map((resource) => {
                    ...
                    // Lógica para mostrar Asignatura O Categoría
                        ...
                        >
                            <div className="p-6">
                                ...
                                <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between text-sm">
                                    <span className="flex items-center gap-1 text-slate-500 dark:text-slate-400 truncate max-w-[60%]">
                                        {!resource.subject && <Tag className="w-3 h-3" />}
                                        {labelContent}
                                    </span>
